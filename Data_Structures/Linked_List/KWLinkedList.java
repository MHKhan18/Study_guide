...
public class KWLinkedList<E> extends AbstractSequentialList<E> {
    ...
    */
    ...
    private class KWListIter implements ListIterator<E> {
        ...
        private int index = 0; // maintains internal state
        ...
        public void add(E obj) {
            if (null == head) { // Add to an empty list.
                head = new Node<E>(obj);
                tail = head;
                ...
                head = newNode; // Step 3
            } else if (null == nextItem) { // Insert at tail.
                // Create a new node.
                Node<E> newNode = new Node<E>(obj);
                ...
                newNode.prev.next = newNode;  // Step 2
                // Link it to the nextItem.
                newNode.next = nextItem;      // Step 3
                newNode.next.prev = newNode;  // Step 4
            }
